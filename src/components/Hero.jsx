  ...
  return (
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-8 text-center lg:text-left order-2 lg:order-1 w-full">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg className="w-full h-14 fill-current text-gray-400 dark:text-gray-600" viewBox="0 0 1440 120" preserveAspectRatio="none">
