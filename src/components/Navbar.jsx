    ...
    >
      ...
      <NavbarContent className="md:hidden " justify="center">
        <NavbarBrand as={Link} to="/" className="group">
          ...
          />
          <span className="text-2xl font-vibes font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gold to-cyan-500 px-1">
            Novel Angel
          </span>
        </NavbarBrand>
      </NavbarContent>
      ...
      <NavbarContent className="hidden md:flex" justify="start">
        <NavbarBrand as={Link} to="/" className="group">
          ...
          />
          <span className="px-1 text-3xl font-extrabold font-vibes text-transparent bg-clip-text bg-gradient-to-r from-gold to-cyan-500">
            Novel Angel
          </span>
        </NavbarBrand>
      </NavbarContent>
